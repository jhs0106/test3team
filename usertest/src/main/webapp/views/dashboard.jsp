...
<div class="col-sm-10" id="operations-dashboard">
    <style>
    ...
    <div class="dashboard-header">
        <h2>운영 대시보드</h2>
        <div class="meta">
            <div>Admin SSE 스트림: <span id="connection-status" class="connection-chip disconnected">연결 대기</span></div>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-card" id="metric-alerts">
            ...
            <div class="value">-</div>
            <div class="sub-value">위험/주의</div>
        </div>
    </div>

    <div class="card-panel">
        <h5 style="font-weight:600; margin-bottom:12px;">라인별 3D 처리량 &amp; 드릴다운</h5>
        <div id="production-3d"></div>
    </div>

    <div class="card-panel">
        <h5 style="font-weight:600; margin-bottom:12px;">설비 세부 지표</h5>
    ...
    <script>
        (function() {
            const baseUrl = (function() {
                const configured = '<c:out value="${adminSseUrl}"/>';
                if (configured && configured !== 'null' && configured !== '') {
                    return configured;
                }
                return window.location.origin + '/api/sse/dashboard';
            })();
