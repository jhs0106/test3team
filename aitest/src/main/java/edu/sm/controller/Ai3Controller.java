...
import edu.sm.app.springai.service3.AiQuoteService;
...
public class Ai3Controller {
    ...
    final private AiQuoteService aiQuoteService;
    ...
    // 명언 생성 및 TTS 반환
    @RequestMapping(value = "/daily-quote")
    public Flux<String> getDailyQuote() {
        return aiQuoteService.generateDailyQuote();
    }

    // 명언을 TTS로 변환
    @RequestMapping(value = "/quote-tts")
    public Map<String, String> quoteTts(@RequestParam("text") String text) {
        byte[] audio = aisttService.tts(text);
